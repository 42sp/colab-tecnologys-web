...
export const N8N_WEBHOOK_URL =
  "https://evolution-n8n.eorpdr.easypanel.host/webhook/f6ddc488-8680-4351-84dd-d9e73b2d102d";
...
export const STATIC_CONTEXTO = {
  obras: [
    {
      ...
      situacao_atual: {
        ...
        observacoes:
          "Leve redução de produtividade nas últimas duas semanas devido à chuva",
      },
    },
    {
      id: "OBR-2025-002",
  ...
  producao_mensal_equipe_elevacao: [
    {
      mes: "Janeiro",
      producao_total_m2: 2010,
      pedreiros: 5,
      produtividade_media_m2_por_pedreiro: 402,
    },
    {
      mes: "Fevereiro",
      producao_total_m2: 2150,
      pedreiros: 5,
      produtividade_media_m2_por_pedreiro: 430,
    },
    {
      mes: "Março",
      producao_total_m2: 2350,
      pedreiros: 6,
      produtividade_media_m2_por_pedreiro: 391,
    },
    {
      mes: "Abril",
      producao_total_m2: 2400,
      pedreiros: 6,
      produtividade_media_m2_por_pedreiro: 400,
    },
    {
      mes: "Maio",
      producao_total_m2: 2600,
      pedreiros: 6,
      produtividade_media_m2_por_pedreiro: 433,
    },
    {
      mes: "Junho",
      producao_total_m2: 2480,
      pedreiros: 6,
      produtividade_media_m2_por_pedreiro: 413,
    },
    {
      mes: "Julho",
      producao_total_m2: 2760,
      pedreiros: 6,
      produtividade_media_m2_por_pedreiro: 460,
    },
    {
      mes: "Agosto",
      producao_total_m2: 2920,
      pedreiros: 7,
      produtividade_media_m2_por_pedreiro: 417,
    },
    {
      mes: "Setembro",
      producao_total_m2: 3100,
      pedreiros: 7,
      produtividade_media_m2_por_pedreiro: 443,
    },
    {
      mes: "Outubro",
      producao_total_m2: 3320,
      pedreiros: 7,
      produtividade_media_m2_por_pedreiro: 474,
    },
  ],
  ...
  evolucao_pedreiro_felipe_bela: [
    {
      ...
      producao_m2: 280,
      dias_trabalhados: 20,
      produtividade_m2_dia: 14.0,
    },
    {
      mes: "Fevereiro",
      producao_m2: 295,
      dias_trabalhados: 19,
      produtividade_m2_dia: 15.5,
    },
    {
      mes: "Março",
      producao_m2: 300,
      dias_trabalhados: 21,
      produtividade_m2_dia: 14.3,
    },
    {
      mes: "Abril",
      producao_m2: 305,
      dias_trabalhados: 20,
      produtividade_m2_dia: 15.25,
    },
    {
      mes: "Maio",
      producao_m2: 315,
    ...
    },
    {
      ...
      producao_m2: 325,
      dias_trabalhados: 21,
      produtividade_m2_dia: 15.4,
    },
    {
      mes: "Agosto",
      producao_m2: 360,
      dias_trabalhados: 22,
      produtividade_m2_dia: 16.4,
    },
    {
      mes: "Setembro",
      producao_m2: 390,
      dias_trabalhados: 21,
      produtividade_m2_dia: 18.6,
    },
    {
      mes: "Outubro",
      producao_m2: 410,
  ...
  alertas_recentes: [
    {
      ...
      nivel: "Médio",
      descricao:
        "Produtividade de João Lima (Pedreiro) caiu 10% na última semana. Requer monitoramento.",
      data: "2025-10-25",
    },
    {
      ...
      nivel: "Alto",
      descricao:
        "Entrega das vigas de sustentação em atraso de 3 dias. Impacto direto no cronograma.",
      data: "2025-10-28",
    },
    {
      ...
      nivel: "Baixo",
      descricao:
        "Ajuste fino necessário em duas conexões hidráulicas no 3º andar.",
      data: "2025-10-27",
    },
  ],
  comparativo_app_vs_realidade_aumentada: {
    ...
    conclusao:
      "O aplicativo permite que o próprio pedreiro registre sua produção diariamente, gerando dados objetivos e imediatos que melhoram o controle de produtividade e a tomada de decisão.",
  },
};
