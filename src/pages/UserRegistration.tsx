...
import PersonalDataForm from '@/components/UserRegistration/PersonalDateForm';
...
const UserRegistration = () => {
  ...
  return (
    <div className="m-10 p-10 shadow-sm rounded-lg border border-gray-200 bg-white h-[100vh]" >
			<h3 className="text-2xl font-bold text-gray-900">Cadastro de Usuário</h3>
			<ResizablePanelGroup
